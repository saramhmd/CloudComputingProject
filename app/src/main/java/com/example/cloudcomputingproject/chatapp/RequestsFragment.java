                            ...
                            if (type.equals("received")) {
                                ...
                                userref.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        final String requestusername = dataSnapshot.child("name").exists() ? dataSnapshot.child("name").getValue().toString() : "";
                                        final String requeststatus = dataSnapshot.child("status").exists() ? dataSnapshot.child("status").getValue().toString() : "";

                                        holder.username.setText(requestusername);
                                        holder.userstatus.setText("You have sent a request to " + requestusername + " (" + requeststatus + ")");
